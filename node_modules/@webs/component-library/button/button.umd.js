    ...
    ***************************************************************************** */
    ...
    function (_super) {
      ...
      Button.prototype.render = function () {
        return T(templateObject_2 || (templateObject_2 = __makeTemplateObject(["<a class=\"module-action button ", "\" href=\"", "\"\n                   ", "\n                   ", ">", "</a>"], ["<a class=\"module-action button ", "\" href=\"", "\"\n                   ", "\n                   ", ">", "</a>"])), this.extraClasses, this.href, this.openInNewTab ? T(templateObject_1 || (templateObject_1 = __makeTemplateObject(["target=\"_blank\""], ["target=\"_blank\""]))) : '', this.rel ? 'rel="' + this.rel + '"' : '', this.text);
      };

      Button.styles = i(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    .button {\n      align-items: center;\n      background: #181A23;\n      border-radius: 2.1rem;\n      color: #fff;\n      cursor: pointer;\n      display: inline-flex;\n      font: 700 .8rem/1.3 lato, sans-serif;\n      justify-content: center;\n      min-width: 180px;\n      outline: none;\n      overflow: hidden;\n      padding: .65rem 1rem;\n      position: relative;\n      text-decoration: none;\n      transition: background .1s linear, border .1s linear, color .1s linear;\n      z-index: 1;\n    }\n\n    .button:hover {\n      background: #FF8A00;\n    }\n\n    .button-pink:hover {\n      background: #FF00FF;\n    }\n\n    .button-violet:hover {\n      background: #9600E6;\n    }\n  "], ["\n    .button {\n      align-items: center;\n      background: #181A23;\n      border-radius: 2.1rem;\n      color: #fff;\n      cursor: pointer;\n      display: inline-flex;\n      font: 700 .8rem/1.3 lato, sans-serif;\n      justify-content: center;\n      min-width: 180px;\n      outline: none;\n      overflow: hidden;\n      padding: .65rem 1rem;\n      position: relative;\n      text-decoration: none;\n      transition: background .1s linear, border .1s linear, color .1s linear;\n      z-index: 1;\n    }\n\n    .button:hover {\n      background: #FF8A00;\n    }\n\n    .button-pink:hover {\n      background: #FF00FF;\n    }\n\n    .button-violet:hover {\n      background: #9600E6;\n    }\n  "])));
