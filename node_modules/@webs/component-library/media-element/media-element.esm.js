 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$1={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},i$2=t=>(...i)=>({_$litDirective$:t,values:i});class s$1{constructor(t){}T(t,i,s){this.Σdt=t,this.M=i,this.Σct=s;}S(t,i){return this.update(t,i)}update(t,i){return this.render(...i)}}

/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const i$3=i$2(class extends s$1{constructor(t){var e;if(super(t),t.type!==t$1.ATTRIBUTE||"style"!==t.name||(null===(e=t.strings)||void 0===e?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((e,r)=>{const s=t[r];return null==s?e:e+`${r=r.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`}),"")}update(e,[r]){const{style:s}=e.element;if(void 0===this.St){this.St=new Set;for(const t in r)this.St.add(t);return this.render(r)}this.St.forEach((t=>{null==r[t]&&(this.St.delete(t),t.includes("-")?s.removeProperty(t):s[t]="");}));for(const t in r){const e=r[t];null!=e&&(this.St.add(t),t.includes("-")?s.setProperty(t,e):s[t]=e);}return w}});

var _templateObject, _templateObject2, _templateObject3;

var MediaElement = /*#__PURE__*/function (_LitElement) {
  _inherits(MediaElement, _LitElement);
  ...
  _createClass(MediaElement, [{
    ...
    value: function render() {
      ...
      return html(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      ", "\n    "])), this.href ? html(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n          <a\n            href=\"", "\" data-lity data-play-embed-video>\n            <picture\n              class=\"", " media_video media_image-", "\" style=", ">\n              <img src=\"", "\" alt=\"", "\" loading=\"lazy\" width=\"", "\">\n            </picture>\n            <div class=\"play-icon\"></div>\n          </a>\n        "])), this.href, this.classes, this.objectFit, i$3(styles), this.imageSrc, this.imageAlt, this.width) : html(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n          <picture\n            class=\"", " media_image media_image-", "\" style=", ">\n            <img src=\"", "\" alt=\"", "\" loading=\"lazy\" width=\"", "\">\n          </picture>\n        "])), this.classes, this.objectFit, i$3(styles), this.imageSrc, this.imageAlt, this.width));
    }
  }]);
...
__decorate([e(), __metadata("design:type", String)], MediaElement.prototype, "classes", void 0);

__decorate([e(), __metadata("design:type", String)], MediaElement.prototype, "href", void 0);

__decorate([e({
  attribute: 'src'
}), __metadata("design:type", String)], MediaElement.prototype, "imageSrc", void 0);

__decorate([e({
  attribute: 'alt'
}), __metadata("design:type", String)], MediaElement.prototype, "imageAlt", void 0);

__decorate([e(), __metadata("design:type", String)], MediaElement.prototype, "height", void 0);

__decorate([e(), __metadata("design:type", String)], MediaElement.prototype, "width", void 0);

__decorate([e({
  type: Boolean
}), __metadata("design:type", Boolean)], MediaElement.prototype, "isVideo", void 0);

__decorate([e({
  attribute: 'object-fit'
}), __metadata("design:type", String)], MediaElement.prototype, "objectFit", void 0);

MediaElement = __decorate([n('webs-media')], MediaElement);
